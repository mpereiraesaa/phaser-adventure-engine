...
module.exports = __webpack_require__(/*! /var/www/project-phaser/src/main.js */332);
...
var _PNCAdventure = __webpack_require__(/*! ../engine/PNCAdventure */ 338);
...
var _Scene = __webpack_require__(/*! ./Scene */ 339);
...
var _Navmesh = __webpack_require__(/*! ./Navmesh */ 340);

var _Navmesh2 = _interopRequireDefault(_Navmesh);

var _Actor = __webpack_require__(/*! ./Actor */ 127);
...
var _constellation = __webpack_require__(/*! ./lib/constellation */ 341);
...
var Navmesh = function () {
  ...
  _createClass(Navmesh, [{
    ...
    key: "addPolygon",
    value: function addPolygon(e, nodes) {
      if (nodes === undefined) {
        nodes = this.currentNodes;
      }
      ...
      if (polygon !== null) {
        ...
        var nodes_arr = Object.keys(this.grid.nodes);

        for (var z = 1; z < nodes_arr.length; z++) {
          var to = Object.keys(this.grid.nodes["" + nodes_arr[z]].to).length;

          if (to < 2) {
            var near_node = this.grid.getNearestNodeToNodeNotSameXY(nodes_arr[z]);
...
var _PlayerActor = __webpack_require__(/*! ../engine/PlayerActor */ 345);
...
var _Actor2 = __webpack_require__(/*! ./Actor */ 127);
